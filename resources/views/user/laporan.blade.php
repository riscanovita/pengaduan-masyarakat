            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pekat.laporan') }}">
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #3abda7" href="#">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
        ...
        <div class="col-lg-8">
            <div class="laporan-top">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <p>{{ $value->tgl_pengaduan->format('d M Y, h:i') }}</p>
                    </div>
                </div>
            </div>
            <div class="laporan-mid">
                ...
                <p>{{ $value->isi_laporan }}</p>
            </div>
            <div class="laporan-bottom">
                @if ($value->foto != null)
                <img src="{{ Storage::url($value->foto) }}" alt="{{ 'Gambar '.$value->judul_laporan }}" class="gambar-lampiran">
                @endif
                @if ($value->tanggapan != null)
                <p class="mt-3 mb-1">{{ '*Tanggapan dari '. $value->tanggapan->petugas->nama_petugas }}</p>
                <p class="light">{{ $value->tanggapan->tanggapan }}</p>
                @endif
            </div>
            <hr>
        </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 PEKAT • All rights reserved</p>
    </div>
</div>
@endsection
